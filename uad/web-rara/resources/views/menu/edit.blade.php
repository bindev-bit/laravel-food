<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="flex justify-between">
            <h2 class="text-2xl font-extrabold text-gray-900">Update Menu - {{ $menu->name }}</h2>
            <div>
                ...
                <form class="inline-block" action="{{ route('menu.destroy', $menu->id) }}" method="POST">
                    @csrf
                    @method('delete')
        ...
        <form class="inline-block" action="{{ route('menu.update', $menu->id) }}" method="POST"
            ...
            <div class="md:grid mt-5 md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Detail menu</h3>
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidde">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="name" id="name" autocomplete="name" value="{{ $menu->name }}"
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" rows="3"
                                        ...
                                        placeholder="Description for more informations">{{ $menu->description }}</textarea>
                                </div>
                                <p class="mt-2 text-sm text-gray-500">
                                    Brief description for new menu.
                                </p>
                            </div>
                                        ...
                                        <div class="mx-auto text-sm text-gray-600">
                                            <label for="image_url"
                                                ...
                                                <input id="image_url" name="image_url" type="file" accept="image/png"
                                                    value="{{ $menu->image_url }}" class="sr-only"
