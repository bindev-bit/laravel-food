        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <form class="inline-block" action="{{ route('list-carts.destroy', auth()->user()->id) }}"
                            method="POST">
                            @csrf
                            @method('delete')
                                ...
                                <div class="group relative">
                                    <a href="#" @click="detail = true">
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('storage/' . $pd->menu->image_url) }}"
                                        ...
                                        <div class="mt-4 flex justify-between">
                                            <div>
                                                ...
                                                <p class="mt-1 text-sm text-gray-500">{{ $pd->menu->description }}
                                                </p>
                                            </div>
                                            <p class="text-sm font-medium text-gray-900">{{ $pd->menu->price }}
                                            </p>
                                        </div>
                                    </a>
                                                    ...
                                                    <div class="sm:col-span-8 lg:col-span-7">
                                                        ...
                                                        <form action="{{ route('list-carts.destroy', $pd->id) }}"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                class="mt-6 w-full bg-red-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                                                Remove
                                                            </button>
                                                        </form>
