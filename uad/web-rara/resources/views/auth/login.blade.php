<x-guest-layout>
    <section class="min-h-screen flex items-center justify-center w-full px-8 py-16 bg-gray-100 xl:px-8">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <x-jet-input id="email" class="block mt-1 w-full" type="email"
                                    placeholder="admin@admin.com" name="email" :value="old('email')" required
                                    autofocus />
                            </div>
                            ...
                            <div class="block mt-4">
                                <button type="submit"
                                    class="w-full px-3 py-4 font-medium text-white bg-blue-600 rounded-lg">Log Me
                                    In</button>
                            </div>
                            <p class="w-full mt-4 text-sm text-center text-gray-500">Don't have an account? <a
                                    href="{{ route('register') }}" class="text-blue-500 underline">Sign up here</a>
                            </p>
                        </div>
                    </div>
